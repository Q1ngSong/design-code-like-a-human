...
| 新想法和旧方案对比、和 baseline 比：开跑前冻结对照协议 | [comparing-methods-fairly](../comparing-methods-fairly/SKILL.md) |
| 方法和权重已定型，只评测：最终数字、补测 benchmark | [evaluating-frozen-methods](../evaluating-frozen-methods/SKILL.md) |
